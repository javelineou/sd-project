...
<html lang="en">
  ...
  <body>
	...
	<!--Vote form-->
	<div class="container">
	<form class="row row-cols-lg-auto g-3 align-items-center" action="vote-action2.php" method="POST">

		<input type="submit" value="Vote A" class="btn btn-primary mx-2" name="submitA">
    <input type="submit" value="Vote B" class="btn btn-primary mx-2" name="submitB">
    <input type="submit" value="Vote C" class="btn btn-primary mx-2" name="submitC">
