...
<?php
	...
	if($total != 0)
	{
		?>
			...
			<h1 style="text-align: center;">Report Records</h1>
			</br></br></br>
		...
		while($result = mysqli_fetch_assoc($data))
		{
				echo " <tr>
						...
						<td> 			
						<a href='report-delete.php?id=$result[id]'><input type='submit' value='Delete' class='delete' onclick='return checkdelete()'></a>
						</td>
					  </tr>
				";
		}
